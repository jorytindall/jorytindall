    ...
    <Layout>
      <Wrapper>
        <div className='content'>
          ...
          <Paragraph textAlign='center'>This page is password protected for confidentiality reasons. Please <Link to='/contact'>contact</Link> for access and more information.</Paragraph>
