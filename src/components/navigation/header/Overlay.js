                    ...
                    {data.allSanityPortfolioProject.edges.map(project => {
                        return (
                            <FeaturedItem
                                ...
                                alternativeText={project.node.featuredImage.alternativeText}
...
const NavLink = styled(Link)`
    ...
    transition: color 150ms cubic-bezier(.78,.01,.51,.99), transform 150ms cubic-bezier(.78,.01,.51,.99);
    margin: 0.25rem 0;
    display: block;
    transform: none;
    ...
    &:active { color: var(--color-primary-shade); }
`
