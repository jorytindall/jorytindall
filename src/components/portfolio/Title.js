...
const Title = ({ 
    ...
    return (
        <Wrapper>
            <Content>
                <TitleWrapper>
                    <H6 color='var(--color-primary-shade)' margin='0 0 1rem 0'>{client}</H6>
                ...
                <Details>
                    ...
                    <DetailItem>
                        ...
                        <FlexContainer><Badge text={timeline} /></FlexContainer>
                    </DetailItem>
                </Details>
                <Overview><Paragraph lead>{overview}</Paragraph></Overview>
                <TextArrow
                    link={link}
                    text='See it live'
                />
