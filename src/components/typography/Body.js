...
const Paragraph = styled.p`
    ...
    font-size: ${props =>
        props.primary ? `1.125rem` :
        props.secondary ? `0.9rem` :
        props.lead ? `1.375rem` : `1.125rem`};
...
const InternalLink = styled(Link)`
    ...
    &:visited { color: ${props => props.color || `var(--color-primary-main)` }};
    &:focus { color: ${props => props.hover || `var(--color-primary-mediumTint)` }};
    &:hover { color: ${props => props.hover || `var(--color-primary-mediumTint)` }};
