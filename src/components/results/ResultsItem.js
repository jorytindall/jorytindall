...
export const ResultsItem = ({
    ...
    return (
        <Wrapper>
            ...
            {headline && <H6 color="var(--color-accent-01)" margin='0'>{headline}</H6>}
            {description && <Paragraph secondary color="var(--color-primary-light-tint)" margin='0'>{description}</Paragraph>}
        </Wrapper>
    )
}
...
const Arrow = styled.svg`
    ${props => props.direction === 'down' ? `transform: rotateZ(180deg);` : `transform: rotateZ(0deg);`};
`